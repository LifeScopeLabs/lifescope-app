...
if (document.fonts.check('240px Ionicons')) {
    console.log('Ionicons font loaded');
  } else {
    console.log('Ionicons font not loaded.  Waiting for all fonts to load...');
    document.fonts.ready.then(function () {
      console.log('All fonts loaded');
      if (document.fonts.check('240px Ionicons')) {
        console.log('Ionicons font loaded');
      } else {
        console.log('Ionicons still not loaded');
      }
    });
}
...
AFRAME.registerComponent('ionicon', {
    ...
    init: function () {
      ...
      // firefox 41+ chrome 35+
      // if (document.fonts.check(240*this.data.size + 'px Ionicons')) {
      //   console.log('Ionicons font loaded');
      // } else {
      //   console.log('Ionicons font not loaded');
      // }
    ...
    //   console.log(`this.data.size: ${this.data.size}`);
      ...
      var canvas = document.getElementById('canvasIcon-' + data.icon);
      if(canvas == null | canvas == 'undefined') {
        //console.log("creating canvas for " + data.icon);
        // canvas container
        ...
        canvas.id = 'canvasIcon-' + data.icon;//getUniqueId('canvasIcon');
