...
class Connection extends LSObj {
	constructor(obj) {
		...
		this.last_successful_run = obj.last_successful_run || Date.now();
		this.name = obj.name || '';
...
class Contact extends LSObj {
	constructor(obj) {
		...
		this.name = obj.name || '';
		this.person = obj.hydratedPerson ? new Person(obj.hydratedPerson) : {};
		this.provider_name = obj.provider_name || '';
...
class Event extends LSObj {
	constructor(obj) {
		...
		this.hidden = obj.hidden || false;
		this.identifier = obj.identifier || '';
		this.location = obj.hydratedLocation || null;
...
class Person extends LSObj {
	constructor(obj) {
		...
		this.contact_id_strings = obj.contact_id_strings || '';
		this.tagMasks = obj.tagMasks || {
			added: [],
			removed: [],
			source: []
