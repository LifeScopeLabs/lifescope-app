<template>
    <div id="body"
         v-bind:class="[{ authenticated: $store.getters.authenticated }, $store.getters.theme, $store.state.pageName, $store.state.view]"
    >
...
<script>
	...
	import VueMain from '../components/main/explorer.vue';
