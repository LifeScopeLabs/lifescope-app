<template slot="menu">
    <transition name="menu">
        <aside v-if="$store.state.menu.open"
               id="menu"
            ...
            <section class="scroller">
                <div class="menu">
                    <header>
                        ...
                        <i id="close-menu"
                           class="fal fa-times"
                           v-on:click="$store.state.menu.open = false"
                        ></i>
                    </header>
                    ...
                    <section>
                        <div class="views">
                            ...
                            <transition name="menu-drop">
                                <div v-if="$store.state.mobileViewSelectorOpen === true"
                                     class="drawer"
                                >
                                    <a data-view="feed"
                        ...
                        <div v-if="$store.state.mode === 'home'"
                             class="home-sort"
                        >
                            <div class="current"
                            ...
                            <transition name="menu-drop">
                                <div v-if="$store.state.mobileSortSelectorOpen === true"
                                     class="fields drawer"
                                >
                                    <div v-if="$store.state.home.tab === 'searches'">
                                        ...
                                        <a data-sort="top"
                                           v-bind:class="{ active: $store.state.home.sort === 'top' }"
                                           v-on:click="setHomeSort('top')"
                                        >
                                            <span>Top</span>
                                        </a>
                                        <a data-sort="recent"
                                           v-bind:class="{ active: $store.state.home.sort === 'recent' }"
                                    ...
                                    <div v-if="$store.state.home.tab === 'people'">
                                        ...
                                        <a data-sort="middle_name"
                                           v-bind:class="{ active: $store.state.home.sort === 'middle_name' }"
                                           v-on:click="setHomeSort('middle_name')"
                                        >
                                            <span>Middle</span>
                                        </a>
                                        <a data-sort="last_name"
                                           v-bind:class="{ active: $store.state.home.sort === 'last_name' }"
                                    ...
                                    <div v-if="$store.state.home.tab === 'tags'">
                                        ...
                                        <a data-sort="shared"
                                           v-bind:class="{ active: $store.state.home.sort === 'shared' }"
                        ...
                        <div class="facets">
                            ...
                            <transition name="menu-drop">
                                <div v-if="$store.state.mobileFacetSelectorOpen === true"
                                     class="drawer"
                                >
                                    <a v-bind:class="{ active: $store.state.facet === 'events' }"
                                       v-on:click="setFacet('events')"
                                    >Events
                                    </a>
                        ...
                        <nuxt-link v-if="$store.state.mode !== 'shared'"
                                   class="live"
                                   v-bind:class="{ active: $store.state.pageName === 'explorer' }"
                                   to="/explore"
                        >
                            <i class="fal fa-rocket blue"></i>
                            Search
                        </nuxt-link>
                        <nuxt-link v-if="$store.state.mode !== 'shared'"
                                   class="providers"
                                   v-bind:class="{ active: $store.state.pageName === 'providers' }"
                                   to="/providers"
                        >
                        ...
                        <nuxt-link v-if="$store.state.mode !== 'shared'"
                                   class="settings"
                                   v-bind:class="{ active: isSettingsPage() === true }"
                                   to="/settings"
                        >
                        ...
                        <a class="support"
                           href="http://bitscoop.com/support"
                        >
                    ...
                    <footer>
                        ...
                        <div>
                            <a href="https://www.bitscooplabs.com">&copy; 2014-{{ new Date().getFullYear() }} BitScoop
                                Labs, Inc.
                            </a>
