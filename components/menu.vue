		...
		<section class="scroller">
			<div class="menu">
              ...
              <a v-if="$store.state.view !== 'map'" v-bind:class="{ active: $store.state.facet === 'contacts' }" v-on:click="setFacet('contacts')">Contacts</a>
					...
					<a v-if="$store.state.mode !== 'shared'" class="live" href="/explore"><i class="fas fa-rocket blue"></i> Search</a>
					<a v-if="$store.state.mode !== 'shared'" class="providers" href="/providers"><i class="fas fa-plug"></i> Add Connections</a>
					<a v-if="$store.state.mode !== 'shared'" class="settings" href="/settings"><i class="fas fa-cog"></i> Settings</a>
