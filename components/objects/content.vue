<template>
    ...
    <transition name="content" mode="out-in">
        <div v-bind:key="1" v-if="$store.state.view === 'feed'" class="object feed" v-bind:id="content.id">
            <div class="items">
        ...
        <!-- grid -->
        <div v-bind:key="2" v-else-if="$store.state.view === 'grid'"
             class="item grid"
        ...
        <!-- list -->
        <div v-bind:key="3" v-else-if="$store.state.view === 'list'"
             class="item list"
             v-bind:id="content.id"
             v-on:click="$emit('render-details', content, 'content')">
            <div>
