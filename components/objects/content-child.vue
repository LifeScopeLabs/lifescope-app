<template>
	<div v-if="content.hidden !== true" class="object content" v-bind:id="content.id">
		<!-- header -->
		<div class="header">
			<!-- type -->
			<div class="type">
		...
		<div class="content-embed"
			...
			<audio v-if="isAudio(content)"
				   controls v-observe-visibility="{ callback: visbilityChanged, throttle: 500 }"
			...
			<img v-if="isImage(content)"
				 v-observe-visibility="{ callback: visbilityChanged, throttle: 500 }" v-bind:src="content.embed_content"
			...
			<iframe v-if="isEmail(content)"
					v-observe-visibility="{ callback: visbilityChanged, throttle: 500 }" frameBorder="0"
		...
		<div v-if="content.title != null && content.title.length > 0" class="title">
			<a v-if="content.url != null && content.url.length > 0" v-bind:href="content.url" target="_blank">{{
				content.title | safe }}</a>
