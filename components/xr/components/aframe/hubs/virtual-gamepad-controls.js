...
AFRAME.registerComponent("virtual-gamepad-controls", {
  ...
  onMoveJoystickChanged(event, joystick) {
    //console.log("onMoveJoystickChanged");
    ...
    if (rot['x'] !== 0) {
      ...
      // console.log('rot["x"] !== 0');
      // console.log(rot);
      this.el.setAttribute("rotation", {'x': 0, 'z': 0, 'y': rot['y']});
      // console.log(this.el.getAttribute('rotation'));
    }
    this.moving = true;
    this.moveEvent.axis[0] = xx;
    this.moveEvent.axis[1] = zz;
  },
