        ...
        <section>
            ...
            <section class="flexbox flex-column flex-grow">
                <transition appear
                            name="opacity"
                >
                    <section v-if="$store.state.mode === 'account'"
                             id="account"
                             key="account"
                    >
                        <div class="boxed-group person">
                            <div class="title">
                                Profile
                                <i v-bind:class="{ shown: $data.profileUpdated === true }"
                            ...
                            <div class="padded paragraphed form">
                                <div class="flexbox flex-column avatar-container">
                                    ...
                                    <div v-if="this.$store.state.person.first_name != null || this.$store.state.person.last_name != null || this.$store.state.person.avatar_url != null"
                                         class="avatar"
                                         v-bind:class="{ 'default-only': hasAvatars() !== true }"
                                    >
                                        <i class="fal fa-2x fa-chevron-left"
                                           v-on:click="changeAvatar(-1)"
                                        ></i>
                                        <img v-if="this.$store.state.person.avatar_url != null && this.$store.state.person.avatar_url.length > 0"
                                             v-bind:src="this.$store.state.person.avatar_url"
                                             v-on:error="changeAvatar(0)"
                                        >
                                        <div v-else-if="this.$store.state.person.avatar_url == null || this.$store.state.person.avatar_url.length === 0"
                                             class="default"
                                             v-bind:style="{ 'background-color': defaultColor($store.state.person) }"
                                        >
                                            {{ defaultLetter($store.state.person) }}
                                        </div>
                                        <i class="fal fa-2x fa-chevron-right"
                                           v-on:click="changeAvatar(1)"
                                        ></i>
                                    </div>
                                    ...
                                    <div class="flexbox external-avatar">
                                        ...
                                        <div v-if="$data.externalAvatarError === true"
                                             class="error"
                                        >
                                            This URL is broken in some way, or the image is larger than 1MB
                                        </div>
                                    </div>
                                    <div class="text-box shrink">
                                        <input v-model="$store.state.person.external_avatar_url"
                                               type="text"
                                               title="name"
                                ...
                                <div class="flexbox flex-column names">
                                    <div class="flexbox flex-column">
                                        ...
                                        <div class="text-box shrink">
                                            <input v-model="$store.state.person.first_name"
                                                   type="text"
                                                   title="name"
                                    ...
                                    <div class="flexbox flex-column">
                                        ...
                                        <div class="text-box shrink">
                                            <input v-model="$store.state.person.middle_name"
                                                   type="text"
                                                   title="name"
                                    ...
                                    <div class="flexbox flex-column">
                                        ...
                                        <div class="text-box shrink">
                                            <input v-model="$store.state.person.last_name"
                                                   type="text"
                                                   title="name"
                            ...
                            <div class="padded paragraphed">
                                ...
                                <no-ssr>
                                    <toggle-button v-model="toggleValue"
                                                   ...
                                                   v-bind:color="{ checked: '#9b9b9b', unchecked: '#242424' }"
                        ...
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                ...
                                <div class="mobile-flex-center">
                                    <button id="delete"
                                            class="danger"
                                            v-on:click="showAccountDeleteModal"
                                    >
                                        Delete Account
                                    </button>
                                </div>
                    ...
                    <section v-if="$store.state.mode === 'locations'"
                             id="locations"
                             key="locations"
                    >
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                ...
                                <p>
                                    LifeScope can record your location when you visit LifeScope pages. This can greatly
                                ...
                                <div class="flex-mobile">
                                    <button v-if="$store.state.userOne.location_tracking_enabled === true"
                                            ...
                                            class="primary mobile-flex-center"
                                            v-on:click.prevent="showLocationTrackingModal"
                                    >
                                        Disable Location Tracking
                                    </button>
                                    <button v-if="$store.state.userOne.location_tracking_enabled !== true"
                                            id="enable-location-tracking"
                                            class="primary mobile-flex-center"
                                            v-on:click.prevent="showLocationTrackingModal"
                                    >
                                    ...
                                    <button class="danger delete mobile-flex-center"
                                            v-on:click.prevent="showTrackedLocationsDeleteModal"
                                    >
                        ...
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                ...
                                <p>
                                    LifeScope can import Location history from GeoJSON files. Export location data from
                                    Google, Facebook, and other GPS data.
                                </p>

                                <div class="flex-mobile">
                                    <button class="primary mobile-flex-center"
                                            v-on:click="showLocationUploadModal"
                                    >
                                    ...
                                    <button class="danger delete mobile-flex-center"
                                            v-on:click.prevent="showUploadedLocationsDeleteModal"
                                    >
                                        Delete Import Locations
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <section v-if="$store.state.mode === 'connections'"
                             id="connections"
                             key="connections"
                    >
                        ...
                        >
                            <div v-for="connection in orderBy($store.state.connectionMany, 'provider.name')"
                                 ...
                                 v-bind:class="{active : $data.activeConnection === connection.id}"
                                 class="connection boxed-group"
                                 v-bind:data-id="connection.id"
                                 v-bind:data-provider-id="connection.provider.id"
                            >
                                <div class="flexbox flex-x-center flex-space-between title"
                                     v-on:click="toggleActive(connection.id)"
                                >
                                    <div class="icon-name">
                                    ...
                                    >
                                        ...
                                        <div v-else-if="connection.status === 'failed'"
                                             class="updates"
                                        >
                                    ...
                                    <i v-if="$data.activeConnection === connection.id"
                                       class="fal fa-caret-up"
                                    ></i>
                                    <i v-else
                                       class="fal fa-caret-down"
                                    ></i>
                                </div>
                                    ...
                                    <div class="padded paragraphed">
                                        <div v-if="connection.browser == null && connection.oauth_app_name == null">
                                            <div class="flexbox flex-x-center label">
                                                ...
                                                <i class="fal fa-check-circle flex-grow success-icon"
                                                   data-for="name"
                                                   v-bind:data-namespace="connection.name"
                                                ></i>
                                            </div>
                                            <div class="text-box shrink">
                                                <input name="name"
                                                       type="text"
                                                       v-bind:value="connection.name"
                                                       v-on:change="updateName(connection, $event)"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div v-else-if="connection.browser != null"
                                                 class="label"
                                            >
                                                The LifeScope Browser extension only tracks sites you approve.
                                                Adding or Removing Tracked sites can be done in the LifeScope Browser
                                                extension's options menu.
                                            </div>
                                            <div>
                                                <div v-for="(permission, name) in orderBy(connection.provider.sources, 'name')"
                                                     v-bind:key="name"
                                                     class="paragraph "
                                                >
                                                    <div class="flexbox flex-x-center">
                                                        <label>
                                                            <input v-model="$store.state.permissions[connection.id]"
                                                                   class="flag"
                                                                   type="checkbox"
                                                                   v-bind:value="permission.$key"
                                                                   v-on:change="updatePermissions(connection)"
                                                            />
                                                            {{ permission.$value.name }}
                                                        </label>
                                                        <i class="fal fa-check-circle flex-grow success-icon"
                                                           v-bind:data-for="name"
                                                           v-bind:data-namespace="connection.id"
                                                        ></i>
                                                    </div>
                                                    <div class="tooltip"
                                                         data-for=""
                                        ...
                                        >
                                            <button class="primary"
                                                    v-on:click="getConnectionReauthorization(connection)"
                                            >
                                                Reauthorize
                                            </button>
                                            <div>
                                                The changes you have made require you to re-authorize this connection to
                                        ...
                                        >
                                            <button class="primary"
                                                    v-on:click="forceReauthorization(connection)"
                                            >
                                                Reauthorize
                                            </button>
                                            <div>
                                                It looks like we haven't been able to properly fetch data for this
                                                Connection in some time. Please try reauthorizing it by clicking the
                                                button above.
                                            </div>
                                        </div>

                                        <div class="delete-disable">
                                            <button v-if="connection.enabled === true"
                                                    class="danger disable"
                                                    v-on:click.prevent="showDisableModal(connection)"
                                            >
                                                Disable
                                            </button>
                                            <button v-else
                                                    class="primary enable"
                                                    v-on:click.prevent="enableConnection(connection)"
                                            >
                                                Enable
                                            </button>
                                            ...
                                            <button class="danger delete"
                                                    v-on:click.prevent="showConnectionDeleteModal(connection)"
                                            >
                                                Delete
                                            </button>
                                        </div>
                    ...
                    <section v-if="$store.state.mode === 'developer'"
                             id="developer"
                             key="developer"
                    >
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                <p>
                                    LifeScope is an open data platform you can build on. Learn more by reading our
                                    <a href="https://lifescope.io/platform">Documentation</a>
                                    .
                                </p>
                                <p>
                        ...
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                ...
                                <p>
                                    Please see the <a href="https://lifescope.io/platform">Developer Documentation</a>.
                                </p>

                                <div class="mobile-flex-center">
                                    <button id="new-oauth-app"
                                            class="primary"
                                            v-on:click="initializeNewApp"
                                    >
                                        New App
                                    </button>
                                </div>

                                <div v-for="app in orderBy($data.oauthAppMany, 'name')"
                                     v-bind:key="app.id"
                                     class="flexbox app"
                                     v-on:click="editApp(app.id)"
                                >
                    ...
                    <section v-if="$store.state.mode === 'people'"
                             id="people"
                             key="people"
                    >
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                <p>
                                    Manage People in your life easily in one place. Add a record for a person and
                                    associate all of their contacts with a single Person.
                                </p>

                                <div class="mobile-flex-center">
                                    <button id="new-person"
                                            class="primary"
                                            v-on:click="initializeNewPerson"
                                    >
                                        Add Person
                                    </button>
                                </div>
                                ...
                                <div class="flexbox flex-column">
                                    <div v-for="person in orderBy($store.state.personMany, 'first_name')"
                                         v-bind:key="person.id"
                                         class="flexbox person"
                                         v-on:click="editPerson(person.id)"
                                    >
                                        <div class="flexbox flex-column">
                                            <div class="flexbox top-line">
                                                ...
                                                <div class="flexbox flex-column">
                                                    ...
                                                    <div class="contacts">
                                                        <div v-for="contact in person.hydratedContacts"
                    ...
                    <section v-if="$store.state.mode === 'app-create'"
                             id="app-create"
                             key="app-create"
                    >
                            ...
                            <div class="padded paragraphed form">
                                <div class="flexbox flex-column">
                                    <div class="flexbox">
                                        ...
                                        <div v-if="$store.state.app.name.error === true"
                                             class="error"
                                        >
                                            This app must have a name
                                        </div>
                                    </div>
                                    <div class="text-box shrink">
                                        <input v-model="$store.state.app.name.value"
                                               type="text"
                                               title="name"
                                ...
                                <div class="flexbox flex-column">
                                    <div class="flexbox">
                                        ...
                                        <div v-if="$store.state.app.description.error === true"
                                             class="error"
                                        >
                                            This app must have a description
                                        </div>
                                    </div>
                                    <textarea v-model="$store.state.app.description.value"
                                              class="shrink"
                                    ></textarea>
                                </div>
                                ...
                                <div class="flexbox flex-column">
                                    ...
                                    <div class="text-box shrink">
                                        <input v-model="$store.state.app.homepage.value"
                                               type="text"
                                               title="homepage"
                                               placeholder="Enter app homepage URL"
                                        >
                                    </div>
                                </div>
                                ...
                                <div class="flexbox flex-column">
                                    ...
                                    <div class="text-box shrink">
                                        <input v-model="$store.state.app.privacyPolicy.value"
                                               type="text"
                    ...
                    <section v-if="$store.state.mode === 'app-edit'"
                             id="app-edit"
                             key="app-edit"
                    >
                        <div class="boxed-group oauth-app">
                            ...
                            <div class="padded paragraphed form">
                                <div class="client-keys">
                                    ...
                                    <div class="flexbox flex-column">
                                        ...
                                        <button v-if="$store.state.app.clientSecret.value == null"
                                                v-on:click="showClientSecret"
                                        >
                                            Show
                                        </button>
                                        <div v-else>
                                            ...
                                            <div class="flexbox flex-end">
                                                <button class="danger"
                                                        v-on:click="showSecretResetModal"
                                                >
                                                    Generate Secret
                                                </button>
                                            </div>
                                ...
                                <div class="revoke-tokens">
                                    <button class="danger"
                                            v-on:click="showTokenRevokeModal"
                                    >
                                ...
                                <div class="redirects">
                                    ...
                                    <div v-for="redirect in $store.state.app.redirects.value"
                                         v-bind:key="redirect"
                                         class="flexbox flex-x-center redirect"
                                    >
                                        <div>{{ redirect }}</div>
                                        <i class="delete fal fa-times"
                                           v-on:click="removeRedirect(redirect)"
                                        ></i>
                                    </div>

                                    <div class="flexbox flex-x-center new-redirect">
                                        <div class="text-box shrink">
                                            <input v-model="$data.tempRedirect.value"
                                                   type="text"
                                                   placeholder="https://yourapp.com/redirect_path"
                                            >
                                        </div>
                                        <i class="add fal fa-plus"
                    ...
                    <section v-if="$store.state.mode === 'authorized-apps'"
                             id="authorized-apps"
                             key="authorized-apps"
                    >
                        <div class="boxed-group">
                            ...
                            <div class="padded paragraphed">
                                ...
                                <div v-for="app in orderBy($store.state.oauthAppAuthorizedMany, 'name')"
                                     v-bind:key="app.id"
                                     class="app"
                                >
                                    <div class="flexbox">
                                    ...
                                    <div>
                                        <button class="danger"
                                                v-on:click="showAppRevokeModal(app)"
                                        >
                                            Revoke Access
                                        </button>
                                    </div>
                    ...
                    <section v-if="$store.state.mode === 'people-create'"
                             id="people-create"
                             key="people-create"
                    >
                        <div class="boxed-group person">
                            ...
                            <div class="padded paragraphed form">
                                ...
                                <div class="flexbox flex-column">
                                    ...
                                    <div class="flexbox flex-column">
                                        <div v-for="contact in $store.state.person.hydratedContacts"
                                             v-bind:key="contact.id"
                                             class="flexbox hydrated-contact"
                                        >
                                            <div class="flexbox flex-grow">
                                                <i v-if="contact.hydratedConnection"
                                                   v-bind:class="getIcon(contact.hydratedConnection)"
                                                ></i>
                                                <img v-if="contact.avatar_url && contact.avatar_url.length > 0"
                                    ...
                                    <div class="contact-search">
                                        ...
                                        <div class="flexbox flex-column flex-grow">
                                            <div class="flexbox flex-column flex-grow temp-contacts">
                                                <div class="scroller">
                                                    <div v-for="contact in $store.state.objects.contacts"
                                                         v-bind:key="contact.id"
                                                         class="flexbox flex-grow temp-contact"
                                                         v-on:click="addContact(contact)"
                                                    >
                                                        <i v-if="contact.hydratedConnection"
                                                           v-bind:class="getIcon(contact.hydratedConnection)"
                                                        ></i>
                                            ...
                                            <div class="flexbox page-buttons"
                                                 v-bind:class="{ 'first-page': $data.unpersonedContactOffset === 0, 'last-page': $store.state.objects.contacts.length < $data.unpersonedContactLimit }"
                                            >
                                                <i class="fas fa-chevron-left"
                                                   v-on:click="pageUnpersonedContacts(-1)"
                                                ></i>
                                ...
                                <div v-if="this.$store.state.person.first_name != null || this.$store.state.person.last_name != null || this.$store.state.person.avatar_url != null"
                                     class="flexbox flex-column avatar-container"
                                >
                                    <div class="title">Avatar</div>
                                ...
                                <div class="flex-mobile">
                                    ...
                                    <div v-if="$data.error === true"
                                         class="error"
                                    >
                                        There was an error creating this Person.
                                        If this issue persists, please contact support.
                                    </div>
                    ...
                    <section v-if="$store.state.mode === 'people-edit'"
                             id="people-edit"
                             key="people-edit"
                    >
                        <div class="boxed-group person">
                            ...
                            <div class="padded paragraphed form">
                                ...
                                <div class="flex-mobile">
                                    ...
                                    <button class="danger delete"
                                            v-on:click.prevent="showDeletePersonModal"
                                    >
                                        Delete Person
                                    </button>
                                </div>
                                ...
                                <div v-if="$data.error === true"
                                     class="error"
                                >
                                    There was an error updating this Person.
                                    If this issue persists, please contact support.
                                </div>
                            </div>
                        </div>
...
<script>
	...
	import oauthAppRevoke from '../modals/oauth-app-revoke.vue';
	import oauthAppUpdate from '../../apollo/mutations/oauth-app-update.gql';
	import oauthAppDeleteModal from '../modals/oauth-app-delete.vue';
	import oauthSecretResetModal from '../modals/client-secret-reset.vue';
	import oauthTokenRevokeModal from '../modals/oauth-tokens-delete.vue';
	import personCreate from '../../apollo/mutations/person-create.gql';
	import personDeleteModal from '../modals/person-delete.vue';
	...
	import trackedLocationsDeleteModal from '../modals/tracked-locations-delete.vue';
	import uploadedLocationsDeleteModal from '../modals/uploaded-locations-delete.vue';
	...
	export default {
		...
		methods: {
			...
			initializeNewApp: async function() {
				this.$router.push('/settings/apps/create');
			},
			...
			createNewApp: async function() {
				...
				if (error === false) {
					...
					this.$router.push('/settings/apps/' + result.data.oauthAppInitialize.id);
				}
			},

			editApp: async function(id) {
				this.$router.push('/settings/apps/' + id);
			},
