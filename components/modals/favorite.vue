<template>
    <div id="favorite">
        <div class="content padded">
            ...
            <div class="data">
                <i v-bind:class="$store.state.tempSearch.icon"
                   v-bind:style="{'color': $store.state.tempSearch.icon_color}"
                ></i>
                <div class="text-box flex-grow">
                    <input v-model="$store.state.tempSearch.name"
                           type="text"
                           name="search-name"
            ...
            <div class="buttons">
                <div>
                    <button v-if="$store.state.tempSearch.id != null"
                            class="danger"
                    ...
                    <button v-if="$store.state.tempSearch.favorited === true"
