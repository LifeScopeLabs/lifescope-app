        ...
        <div class="body flexbox flex-column flex-x-center">
            <div class="paragraph flexbox flex-column flex-x-center">
                ...
                <div class="instructions" v-if="tryAgain === false">
                    <p>Are you sure?</p>
                    <p>All of your existing OAuth tokens will still work, but you will need to update your application configuration(s) in order to make any new tokens.</p>
                </div>
            ...
            <div class="mobile-buttons">
                ...
                <button class="danger confirm" v-on:click="resetClientSecret">Yes, Generate</button>
            </div>
        </div>
    </div>
</template>
...
<script>
	...
	export default {
		...
		methods: {
            resetClientSecret: async function(connection) {
            	let self = this;
