# Building and running LifeScope app locally
...
## Create config file
You'll need to create a new file in the config folder called dev.json, or dev.json, or whatever you'd like other than 'local.json', 'default.json' and 'production.json'.
